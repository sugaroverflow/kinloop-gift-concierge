...
4. Codex turns the signal into approval-ready gift options.
5. The user approves one option.
6. Supabase records audit events and the gift approval when configured.
